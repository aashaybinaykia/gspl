...
frappe.provide("gspl.utils");

gspl.utils.BarcodeScanner = class BarcodeScanner {
	constructor(opts) {
		this.frm = opts.frm;
...
erpnext.accounts.CustomSalesInvoiceController = class CustomSalesInvoiceController extends erpnext.accounts.SalesInvoiceController {
    scan_barcode() {
		const barcode_scanner = new gspl.utils.BarcodeScanner({frm:this.frm});
		barcode_scanner.process_scan();
	}
}

extend_cscript(cur_frm.cscript, new erpnext.accounts.CustomSalesInvoiceController({frm: cur_frm}));
